...
public class SpringMain {
    public static void main(String[] args) {
        ...
        try (ClassPathXmlApplicationContext appCtx = new ClassPathXmlApplicationContext()) {
            ...
            User find = userService.getWithMeals(100001);
            System.out.println(find.getMeals().get(0).getUser());
            System.out.println(find.getRoles());

            MealService mealService = appCtx.getBean(MealService.class);
            Meal actual = mealService.getWithUser(100003, 100000);
